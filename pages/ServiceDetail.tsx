      ...
      <div className="container mx-auto px-6 lg:px-12 -mt-12 relative z-20">
        <div className="bg-white rounded-[3rem] shadow-2xl overflow-hidden max-w-5xl mx-auto animate-fade-in-up delay-100">
          ...
          <div className="p-8 md:p-12 lg:p-16">
            ...
            <div className="bg-navy-900 text-white p-8 rounded-3xl flex items-start gap-5 shadow-lg relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-4 text-sm font-medium text-white/80">
                   <span className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-400" /> 98% Success Rate</span>
                   <span className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-400" /> Authorized Consultants</span>
                </div>
              </div>
            </div>
